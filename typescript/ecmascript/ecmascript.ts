...
const cpf: string = "123.258.000-58";
...
const turmaA: string[] = ["Maisa", "Ana", "Bia"];
const turmaB: string[] = ["Renan", "Paulo", "Gui", ...turmaA]; // espalhando, spread.
console.log(turmaB); 


function retornarArray(...args: number[]): number[] { // passar vários parâmentros com o '...args' para a função. Ele junta, agrupa.
